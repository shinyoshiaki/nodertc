...
export default class StunServer extends Emitter {
  kSocket = this.socket;
  kHandleMessage = this.kOnMessage.bind(this);
  kHandleClose = this.close.bind(this);
  kHandleListening = () => this.emit("listening");
