...
import { createMessageType } from "./util";
...
const messageType = {
  ...
  CHANNEL_BIND_REQUEST: createMessageType(
    methods.CHANNEL_BIND,
    classType.REQUEST
  ),
  CHANNEL_BIND_RESPONSE: createMessageType(
    methods.CHANNEL_BIND,
    classType.RESPONSE
  ),
  CHANNEL_BIND_ERROR_RESPONSE: createMessageType(
    methods.CHANNEL_BIND,
    classType.ERROR
  )
};
